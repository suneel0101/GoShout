...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('event_event', (
            ...
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Account'])),
        ...
        # Adding model 'ReShout'
        db.create_table('event_reshout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Event'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Account'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('event', ['ReShout'])

        # Adding model 'Account'
        db.create_table('event_account', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('handle', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('event', ['Account'])

    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table('event_event')

        # Deleting model 'ReShout'
        db.delete_table('event_reshout')

        # Deleting model 'Account'
        db.delete_table('event_account')
    ...
    models = {
        ...
        'event.event': {
            ...
            'host': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['event.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'event.reshout': {
            'Meta': {'object_name': 'ReShout'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['event.Account']"}),
